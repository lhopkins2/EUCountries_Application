...
public class CountryTest {
    ...
    Country validData1, validData2,   inValidData1,   inValidData2,  ireland, uk;
    @Before
   ...
   public void addMEP() {
       ...
       assertEquals(1, ireland.getMeps().size());
        ...
        assertEquals(null, ireland.getMeps().get(0).getMepParty());
    ...
    public void listOfMEPs() {
        ...
        ireland.addMEP((mepThree));
        assertEquals(3, ireland.numberOfMEPs());
        assertEquals(true , ireland.listOfMEPs().contains("Ciaran Cuffe"));
        assertEquals(true , ireland.listOfMEPs().contains("Frances Fitzgerald"));
        assertEquals(true , ireland.listOfMEPs().contains("Sean Kelly"));
    ...
    public void listOfMEPsByParty() {
        ...
        assertEquals(true, ireland.listOfMEPsByParty(fineGaelParty).contains("Frances"));
        ireland.addMEP(mepThree);
        assertEquals(3, ireland.noOfMEPsByParty(fineGaelParty));
        assertEquals(true, ireland.listOfMEPsByParty(fineGaelParty).contains("Sean"));
        ireland.addMEP(mepOne);
        assertEquals(3, ireland.noOfMEPsByParty(fineGaelParty));
