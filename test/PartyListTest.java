...
public class PartyListTest {
   ...
   public void getPartyList() {
    ...
    public void removePartyVerifyIndexes() {
        ...
        //removing non-existant Party from populated list
  ...
  // @Test  GONE TO EUDRIVER
//    public void listMEPsbySpecificParty() {
//
//        ukmepOne = new Mep("Rory Palmer", "office@rorypalmer.org", "922 9717", labourParty);
//        ukmepTwo = new Mep("Jackie Jones", "office@jackiejones.org", "922 9718", labourParty);
//        //Party Test Data
//
...
//        euCountries.add(uk);
//        //listing an empty list
//        assertTrue(partyListEmpty.listMEPsbySpecificParty("anything", euCountries).contains("no parties"));
//
//
//        //listing a populated list with an existing genre
//        assertTrue(partyListPopulated.listPartiesBySpecificGenre("right").contains("Leo Varadker"));
